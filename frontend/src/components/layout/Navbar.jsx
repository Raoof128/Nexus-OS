...
export default function Navbar() {
  ...
  return (
    <nav className="relative z-10 w-full border-b border-white/[0.06] bg-transparent">
      <div className="container mx-auto flex h-12 items-center justify-between px-4 sm:h-14 sm:px-6">

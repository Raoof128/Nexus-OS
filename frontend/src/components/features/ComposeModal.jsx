          ...
          >
            ...
            <form onSubmit={handleSubmit} className="flex flex-1 flex-col overflow-hidden">
              <div className="flex-1 overflow-y-auto custom-scrollbar">
                ...
                <div className="border-b border-white/[0.04] px-4 py-2.5">
                  <div className="flex items-center gap-2">
                    <label htmlFor="compose-to" className={labelClass}>To</label>
                    <input
                      ref={toRef}
                      id="compose-to"
                      type="email"
                ...
                <div className="border-b border-white/[0.04] px-4 py-2.5">
                  <div className="flex items-center gap-2">
                    <label htmlFor="compose-cc" className={labelClass}>Cc</label>
                    <input
                      id="compose-cc"
                      type="text"
                      value={cc}
                ...
                <div className="border-b border-white/[0.04] px-4 py-2.5">
                  <div className="flex items-center gap-2">
                    <label htmlFor="compose-subject" className={labelClass}>Subj</label>
                    <input
                      id="compose-subject"
                      type="text"
                      required
